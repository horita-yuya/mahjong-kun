...
> = Equal<YakuPinhu<HAND, WINNING, NAKI>, [1]>;
...
type IsTanyao<HAND extends Hand, WINNING extends HAND[number]> = Equal<
...
type IsToiToi<HAND extends Hand, WINNING extends HAND[number]> = Equal<
...
type IsIpeko<HAND extends Hand, WINNING extends HAND[number]> = Equal<
  YakuIpeko<HAND, WINNING, []>,
  [1]
>;
