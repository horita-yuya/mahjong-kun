...
type RonChildCase1_1 = ExpectTrue<Equal<Calculate<1, 30, "ron", "child", null>, "1000">>;
type RonChildCase1_2 = ExpectTrue<Equal<Calculate<2, 30, "tumo", "child", null>, "500,1000">>;
type RonChildCase1_3 = ExpectTrue<Equal<Calculate<2, 40, "tumo", "child", null>, "700,1300">>;
// ピンヅモは20符として計算
...
type RonChildCase4_1 = ExpectTrue<Equal<Calculate<1, 20, "tumo", "child", null>, "300,500">>;
type RonChildCase4_2 = ExpectTrue<Equal<Calculate<1, 20, "ron", "child", null>, "1000">>;
