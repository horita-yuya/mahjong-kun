...
export type ConcatAll<ALL extends number[][]> = ALL extends [
  infer X,
  ...infer Y,
]
  ? X extends number[]
          ...
          : NUM extends "6"
            ...
            : NUM extends "7"
              ...
              : NUM extends "8"
                ? "9"
                : never;
export type IsContinuousNumber<
  X extends string,
  Y extends string,
  Z extends string,
> = And<Equal<Y, Next<X>>, Equal<Z, Next<Next<X>>>>;

export type Contains<LIST extends any[], ELEMENT> = LIST extends [
  infer X,
  ...infer Y,
]
