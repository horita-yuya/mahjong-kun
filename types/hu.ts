import { ConcatAll, Equal, OrAll } from "./utilType";
...
> = HuValue<[HuBase, HuWinning<STYLE, NAKI extends [] ? true : false>, ...HuHand<HAND, WINNING, NAKI>]>;
...
type HuHand<HAND extends Hand, WINNING extends HAND[number], NAKI extends HAND[number][]> = HuHandChunk<
  Chunk1<HAND>,
  Chunk2<HAND>,
  Chunk3<HAND>,
  Chunk4<HAND>,
